        ...
        <div class="row box margin-x clear-margin padding-x">
            <div class="modal-header " style="border-bottom: 1px solid #a9a9a9;">
                <blockquote style="padding: 0; margin: 0; border: none;color: #000;">
                    ...
                    <tcpAdd style="float: right"></tcpAdd>
                </blockquote>
            </div>
            <div class="modal-body" style="height: 550px;">
                <Checkbox>启用</Checkbox>
                <Button size="small" type="primary" @click="addPlatForm">确认</Button>
                <Table size="small" border :columns="columns1" :data="data1" style="margin-top: 5px;"></Table>
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    import tcpAdd from "./LocalTcpAdd";
    export default {
        name: "LocalTcp",
        components: {
            jk_tabs: JkTabs,tcpAdd
        },
        data(){
            return {
                columns1: [
