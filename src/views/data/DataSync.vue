                ...
                <div style="margin: 15px 10px;">
                    <table border="1" style="width: 100%;">
                        <tr style="height: 40px;">
                            <td style="width: 25%;background-color: #eee;margin-left: 70%;"><span style="float: right;margin-right: 15px;font-size: 12px;">数据库同步模式:</span></td>
                            <td>
                                <Select v-model="type" style="width:100px;margin-left: 15px;">
                                    <Option v-for="type in typeList" :value="type.value" :key="type.value" @click.native="configData(type.value)">{{ type.label }}</Option>
                                </Select>
                            </td>
                        </tr>
                        <tr style="height: 40px;" v-show="isShow">
                            <td style="background-color: #eee;"><span style="float: right;margin-right: 15px;font-size: 12px;">Client IP:</span></td>
