                ...
                <div style="margin: 15px 10px;">
                    <table border="1" style="width: 100%;">
                        <tr style="height: 40px;">
                            <td style="width: 25%;background-color: #eee;margin-left: 70%;"><span style="float: right;margin-right: 15px;font-size: 12px;">通讯结束符:</span></td>
                            <td><Input placeholder="240" style="width: 150px;margin-left: 15px;" /></td>
                        </tr>
                        <tr style="height: 40px;">
                            <td style="background-color: #eee;"><span style="float: right;margin-right: 15px;font-size: 12px;">是否加密:</span></td>
                            <td>
                                <RadioGroup v-model="animal" style="margin-left: 15px;">
