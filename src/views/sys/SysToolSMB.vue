                    ...
                    <div style="margin: 15px 10px;">
                        <table border="1" style="width: 100%;">
                            ...
                            <tr style="height: 40px;">
                                ...
                                <td style="font-size: 12px;"><Input v-model="form.password" style="width: 30%;margin-left: 15px;" /></td>
                            </tr>
                            <tr style="height: 40px;">
                                <td style="width: 25%;background-color: #eee;margin-left: 70%;"><span style="float: right;margin-right: 15px;font-size: 12px;">SMB目录:</span></td>
                                <td style="font-size: 12px;"><Input v-model="form.session_timeout" style="width: 30%;margin-left: 15px;" /></td>
                            </tr>
                        </table>
                    </div>
<!--                </div>-->
                <div>
                    <Button @click="submit()" style="margin: 10px 50%;">确认</Button>
                </div>
